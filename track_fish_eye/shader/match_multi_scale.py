...
class MatchMultiScale1dShader(wgpu_util.RenderShaderBinding):
    ...
    def create_bind_group(
        ...
        kernel_sampler = self.device.create_sampler(min_filter="nearest", mag_filter="nearest")
        ...
        entries = [
            ...
            {"binding": 6, "resource": {"buffer": buffer_threshold, "offset": 0, "size": buffer_threshold.size}},
            {"binding": 7, "resource": {"buffer": buffer_scale_to, "offset": 0, "size": buffer_scale_to.size}},
            {"binding": 8, "resource": {
